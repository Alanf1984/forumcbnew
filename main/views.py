...
def detail(request, slug):
    ...
    context = {
        "post":post,
        "title": "CANADA BRAZIL: "+post.title,
    }
...
def create_post(request):
    ...
    context.update({
        "form": form,
        "title": "CANADA BRAZIL: Crie um novo Post"
    })
...
def latest_posts(request):
    ...
    context = {
        "posts":posts,
        "title": "CANADA BRAZIL: Ultimos 10 Posts"
    }
